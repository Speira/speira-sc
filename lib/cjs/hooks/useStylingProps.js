...
function useStylingProps(params) {
    ...
    const augmentedSyle = (0, react_1.useMemo)(() => (Object.assign(Object.assign({}, style), (0, components_utils_1.injectStatusStyle)({ status, theme, spreading }))), [style, status, spreading, theme]);
