...
function Slide(props) {
    ...
    const { className, children, duration, flexStyle } = props, rest = __rest(props, ["className", "children", "duration", "flexStyle"]);
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [!!hideAfter && (0, jsx_runtime_1.jsx)(Styled_1.Styled, { className: smaller, children: children }), (0, jsx_runtime_1.jsxs)(StyledSlide_1.StyledSlide, { className: larger, "$responsive": flexStyle, "$range": range, "$width": width, "$duration": duration, style: {
                    ...
                    visibility: ref.current ? "visible" : "hidden",
                        ...
                        }, children: [react_1.Children.map(children, (child, ind) => ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: "sp-item" }, getRef(ind), { children: child })))), react_1.Children.map(children, (child, ind) => ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: "sp-item" }, getRef(ind), { children: child }))))] }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "sp-prev", disabled: index === 0, onClick: () => setIndex(index - 1), children: "<" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "sp-next", disabled: index === count - range, onClick: () => setIndex(index + 1), children: ">" })] })] }));
}
exports.Slide = Slide;
