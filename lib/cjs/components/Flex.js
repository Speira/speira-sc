...
function Flex(props, ref) {
    const { as, children, flexStyle, id, href, testId } = props, rest = __rest(props, ["as", "children", "flexStyle", "id", "href", "testId"]);
    const { className, style } = (0, useStylingProps_1.default)(props);
    return ((0, jsx_runtime_1.jsx)(Styled_1.Styled, Object.assign({}, rest, { as: as, "$responsive": flexStyle, className: className, "data-testid": testId, href: href, id: id, ref: ref, style: style, children: !href ? (children) : ((0, jsx_runtime_1.jsx)(Styled_1.Styled, { as: "a", href: href, children: children })) })));
}
exports.Flex = Flex;
