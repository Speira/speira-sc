 ...
 * @styled-component
 */
export declare const StyledInput: import("styled-components").IStyledComponent<"web", {
...
export declare function StyledTextarea<T extends object>(props: T): import("react/jsx-runtime").JSX.Element;
