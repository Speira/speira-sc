 ...
 *
 */
export declare const UnstyledLink: import("styled-components").IStyledComponent<"web", {
 ...
 *
 */
export declare const StyledLink: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").Substitute<import("react").DetailedHTMLProps<import("react").AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>, Responsive>>;
type LinkableType = {
    children?: ReactNode;
    link?: string;
};
 ...
 */
export declare function Linkable(props: LinkableType): import("react/jsx-runtime").JSX.Element;
export {};
